...
\usepackage[xetex,linkcolor=black,pdfborder={0 0 0},pdfpagelabels=true]{hyperref} % Format links for pdf
...
\usepackage[backend=biber,style=unified,maxcitenames=2,maxbibnames=99,doi=false,url=false]{biblatex}
\usepackage{amsmath}
