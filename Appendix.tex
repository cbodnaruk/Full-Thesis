...
\section{Lhokpu}
During this project, primary data was collected on Lhokpu (Subgroup unclear: Bhutan) to fill in a gap in the available data. As has been discussed above, Lhokpu has been hypothesised as aligning with the Dimalish subfamily, and while the conclusions in \citeA{Grollmann2018} are certainly well supported, they have not been totally proven. As such, Lhokpu has been included in this study as an internal isolate of unclear subfamily per \citeA{VanDriem2014}. An additional benefit of this field work was allowing this thesis to consider data from both secondary sources (in the form of other grammars), and here a primary source. While this does not necessarily add any substantial quantitative benefit to the database developed in \cref{c:Methods}, it gave me a better understanding of the manifestation of epistemic marking in actual language use, and the descriptive and analytical process undertaken in the secondary sources referenced.
