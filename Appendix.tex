...
\begin{landscape}
       ...
       \begin{longtable}{p{1.5cm}p{1cm}p{1cm}|p{0.25cm}|p{0.25cm}p{0.25cm}p{0.25cm}p{0.25cm}|p{0.25cm}p{0.25cm}p{0.25cm}p{0.25cm}p{0.25cm}p{0.25cm}|p{0.25cm}p{0.25cm}p{0.25cm}p{0.25cm}p{0.25cm}|p{1.5cm}|p{0.5cm}p{0.5cm}|p{1cm}p{0.25cm}p{0.25cm}p{0.25cm}}
              ...
              \multicolumn{3}{l|}{A: Language Metadata} & B & \multicolumn{4}{l|}{C: Scope and Form} & \multicolumn{6}{|l|}{D: Functions: Canonical} & \multicolumn{5}{l|}{E: Functions: Non-Can} & F & \multicolumn{2}{|l|}{G: Addr} & \multicolumn{4}{l}{H: Other} \\
Language & Subfamily & Coordinates &  & C1 & C2 & C3 & C4 & EM & Ev & Ego & Eng & Mir & Oth & EM & Ev & Ego & Eng & Mir &  & G1 & G2 & H1 & H2 & H3 & H4 \\ \hline \endfirsthead
