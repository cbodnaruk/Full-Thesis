...
The total number of languages showing examples of typological category presented in this section is given in \tabref{t:Description:SizeStats}. Here, languages have only been included once, by their most salient categorisation, even though these distinctions can be more gradual than binary, as discussed above. This data is plotted geographically for analysis alongside historical factors in \cref{c:History}.

\begin{table}\caption{The number of languages surveyed in each of the typological categories presented in \sref{sss:Description:GroupSize}.}\label{t:Description:SizeStats}
        \centering
        \begin{tabular}{lcc}
                \hline
         & Number & Percentage \\ \hline
        No Epistemic Marking & 12 & 19\% \\
        Single Term: Reportative & 8 & 13\% \\
        Single Term: Other & 11 & 18\% \\
        Complex: Scattered & 7 & 11\% \\
        Complex: Paradigmatic & 24 & 39\% \\ 
        Total & 62 & 100\% \\ \hline
        \end{tabular}
        \end{table}
...
\begin{exe}
        ...
        \begin{xlist}
                ...
                \gll [nang=chenék-Cē pēi a-tūm] \textbf{pu} \\
                1/2:\textsc{nsubj}=torture-\textsc{neg} mother \textsc{poss-pl} \textsc{\textbf{quot}} \\
                \glt ```She won't torture you, mothers'', he said.' (p. 560)

                \ex\label{e:Description:KarbiReport}
                \gll Bēy a-tūm kortè bàng-kethòm dō \textbf{tànghò} \\
                \textsc{clan} \textsc{poss-pl} brother \textsc{clf:hum:pl}-three \textsc{exist} \textsc{\textbf{rep}} \\
                \glt `... there were three Bey brothers, they say.' (p. 562)

                \ex\label{e:Description:KarbiBoth}
                \gll a-ingjìr=tā dō \textbf{pu} \\
                \textsc{poss}-sister=\textsc{add} \textsc{exist} \textsc{\textbf{quot}} \\
...
\begin{exe}
        ...
        \gll * sang.nyin nga na-gi-\textbf{yin} \\
        {} tomorrow \textsc{1.sg} sick-\textsc{fut}-\textsc{\textbf{ego}} \\
...
\begin{exe}
        ...
        \begin{xlist}
                ...
                \gll khasa nga na-\textbf{byung} \\
                yesterday \textsc{1.sg} sick-\textsc{\textbf{pfv.exp.ego}} \\
                \glt `Yesterday I got sick.' \cite[Lhasa Tibetan,][169]{Garrett2001}

                \ex\label{e:Description:LhasaEgoAbsExperiencer}
                \gll kho-s nga-r gzhus-\textbf{byung} \\
                \textsc{3.sg-erg} \textsc{1.sg-dat} hit-\textsc{\textbf{pfv.exp.ego}} \\
...
\begin{exe}
        ...
        \gll ma-gi-khe \textbf{wa} \\
        \textsc{neg}-understand-\textsc{impf} \textsc{\textbf{ded}} \\
...
\begin{exe}
        ...
        \begin{xlist}
                ...
                \gll Ama khamung zik-\textbf{ca} \\
                mother clothes wash-\textsc{\textbf{cop}} \\
                \glt `Mother is washing the clothes.' (p. 228) \\
                \ex\label{e:Description:TshanglaPresMir}
                \gll Ama khamung zik-\textbf{la} \\
                mother clothes wash-\textsc{\textbf{cop.mir}} \\
                \glt `Mother is evidently washing the clothes.' (p. 229) \\
                \ex\label{e:Description:TshanglaNarrativeNonMir}
                \gll Bozong zong-nyi, laga-gi chom-nyi che-wa-\textbf{la} \\
                cassava boil-\textsc{nf} leaf-\textsc{agt} wrap-\textsc{nf} plant-\textsc{nom}-\textsc{\textbf{cop.mir}} \\
...
\begin{exe}
        ...
        everything also play \textsc{nmlz} \textsc{neg} \textsc{exist} \textsc{\textbf{epis.emp}} that \textsc{cl:tmp} \textsc{top} \\
